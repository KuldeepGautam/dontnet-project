...
/// <summary>
/// Validates the JWTs issued by AIM (<c>UBIS.Services.Aim.Infrastructure.Security.JwtTokenFactory</c>)
/// — MenuGenerator never issues its own tokens, only validates AIM's with the same shared
