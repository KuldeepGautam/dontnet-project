...
/// <summary>Validates the JWTs issued by AIM — Reporting never issues its own tokens, only validates AIM's with the same shared SecretKey/Issuer/Audience.</summary>
