...
/// <summary>
/// Lazily creates and shares a single RabbitMQ connection for the process — same shape as
/// Core/Email/Infrastructure/Messaging/RabbitMqConnectionProvider.cs and
/// Gateway/UBIS.ApiGateway/Logging/RabbitMqConnectionProvider.cs (every service in this solution
/// has its own copy rather than a shared package — see UBIS_Web/CLAUDE.md on why).
/// </summary>
