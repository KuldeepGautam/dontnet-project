...
public class EclApprovalAuthorityConfiguration : IEntityTypeConfiguration<EclApprovalAuthority>
{
    public void Configure(EntityTypeBuilder<EclApprovalAuthority> builder)
    {
        builder.ToTable("M_ECLApprovalAuthority", "dbo", t => t.ExcludeFromMigrations());
        builder.HasKey(e => e.AuthorityId);
        builder.Property(e => e.AuthorityId).HasColumnName("AuthorityId").ValueGeneratedOnAdd();
        builder.Property(e => e.AuthorityName).HasColumnName("AuthorityName").HasMaxLength(400).IsRequired();
