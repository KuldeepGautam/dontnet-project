...
/// <summary>
/// Restricts calls to this service to whoever holds the shared internal key (i.e. UBIS_Web). This
/// is the only auth layer PreBudget has for service-to-service calls - it does not validate JWTs
/// itself for this check (that's a separate, per-endpoint [Authorize] concern).
/// </summary>
