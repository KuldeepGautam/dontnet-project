...
/// <summary>
/// Lazily creates and shares a single RabbitMQ connection for the process. Copied from
/// Core/Email's identical class — this solution duplicates this class per microservice rather than
/// sharing a library (see AppSettingsReader's own doc comment for the rationale). Added 2026-08-14.
/// </summary>
