...
public class AppendixEstimatesOfSchemesConfiguration : AppendixEntityConfigurationBase<AppendixEstimatesOfSchemes>, IEntityTypeConfiguration<AppendixEstimatesOfSchemes>
{
    public void Configure(EntityTypeBuilder<AppendixEstimatesOfSchemes> builder)
    {
        ConfigureCommon(builder, "Appendix_IV_EstimatesOfSchemes");
        ...
        builder.Ignore(e => e.PercentWrtBE);
    }
}
