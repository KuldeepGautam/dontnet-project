...
public class AppendixScspExpenditureConfiguration : AppendixEntityConfigurationBase<AppendixScspExpenditure>, IEntityTypeConfiguration<AppendixScspExpenditure>
{
    public void Configure(EntityTypeBuilder<AppendixScspExpenditure> builder)
    {
        ConfigureCommon(builder, "Appendix_IVA_ScspExpenditure");
