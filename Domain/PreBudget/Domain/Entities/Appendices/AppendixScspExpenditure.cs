...
/// <summary>Appendix IV-A: Estimates under Special Component Plan for Scheduled Castes (Minor Head 789). Maps to dbo.AppendixScspExpenditure (was legacy Temp_IVA_SCSubPlan).</summary>
public class AppendixScspExpenditure : AppendixEntityBase
{
