namespace UBIS.Services.UserProfile.Infrastructure.Logging;
...
/// microservice listens on. Every message is prefixed with "UserProfile Microservice - {Level} - "
/// so entries stay identifiable in LogWriter's shared Logs table without needing a schema change there.
...
{
    private const string ServiceTag = "UserProfile Microservice";
